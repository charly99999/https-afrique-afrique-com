...
export function MobileShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-surface">
      <main className="mx-auto max-w-[440px] min-h-screen bg-background pb-28 shadow-soft">
        {children}
      </main>

      <nav className="fixed bottom-0 left-1/2 z-50 w-full max-w-[440px] -translate-x-1/2 border-t border-border bg-background/95 px-6 pb-7 pt-3 backdrop-blur-xl">
